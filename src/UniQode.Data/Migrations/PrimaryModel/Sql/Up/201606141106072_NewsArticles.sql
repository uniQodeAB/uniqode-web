...
INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (24, 'PER ERICSON JOINS UNIQODE', 'per-ericson-joins-uniqode', 'Per Ericson, super skilled and experienced .Net developer chose uniQode & Qgroup for his next career step. We are very happy and proud that Per chose uniQode to continue his career as true specialist! Per joins us from RealTest and his first assignment at uniQode are at Com Hem. Welcome Per!', '2015-05-07', '2015-05-07')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (28, 'MARTIN BOHGARD, FRONTEND SPECIALIST TO UNIQODE', 'martin-bohgard-frontend-specialist-to-uniqode', 'We are proud to announce that Martin Bohgard joins uniQode. Martin is a gifted and experienced designer that really loves his craftsmanship. Martin joins us from Chas and his first assignment at uniQode is at Propellerhead. Big welcome Martin!', '2015-08-12', '2015-08-12')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (31, 'SUPER TALANTED CARL RIPA TO UNIQODE', 'super-talented-carl-ripa-to-uniqode', 'We are very delighted and proud that the super talented Carl Ripa joins uniQode! Carl joins us from Dynabyte and his first assignment at uniQode are at Tele2. Welcome Carl!!', '2015-08-24', '2015-08-24')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (36, 'WELCOME TO UNIQODE MAGNUS RYDÉN!', 'welcome-to-uniqode-magnus-rydn', 'We are proud and happy to inform that Magnus Rydén chose uniQode for his next career step. Magnus is a truly skilled .Net developer with expertise knowledge whitin GIT and FrontEnd. Magnus is joining us from ÅF and his first assignment at uniQode is at AtlasCopco.', '2015-10-01', '2015-10-01')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (39, 'CODING ROCK STAR KEITH GIBBS JOINS UNIQODE', 'coding-rock-star-keith-gibbs-joins-uniqode', 'We are happy to announce that the american ECMAScript warrior and coding rock star Keith Gibbs joins uniQode. Keith are joining us from HiQ and are performing his arts at ViaPlay as first assignment at uniQode.', '2015-10-22', '2015-10-22')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (42, 'JOHAN ALLANSSON CONNECTS WITH UNIQODE', 'johan-allansson-connects-with-uniqode', 'Johan is a extraordinary developer with a keen sense for systems design and an enthusiasm for large-scale, highly available distributed systems. Johan joins us from Dynabyte and his first assignment at uniQode will be at Svensk Adressändring. Welcome Johan!', '2015-11-23', '2015-11-23')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (48, 'PER THOMASSON, SENIOR WEB DESIGNER JOINS UNIQODE', 'per-thomasson-senior-web-designer-joins-uniqode', 'It is with pride and happines we welcome Per Thomasson to uniQode! Per is a Senior Webdesigner and Developer who create magic at Förenade Liv at the beginning of his journey with uniQode. Big Welcome Per!', '2016-01-15', '2016-01-15')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (51, 'CHRISTER ZIELINSKI TO UNIQODE', 'christer-zielinski-to-uniqode', 'We are pleased and happy to announce that Christer Zielinski now is a part of uniQode and that Christer has chosen uniQode as his next step in his career. Christers main focus is web development and .Net platform. Christer starts his first assignment at uniQode with PayEx. Welcome to uniQode Christer!', '2016-03-01', '2016-03-01')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (85, 'AWAT SULEIMANPOOR JOINS UNIQODE', 'awat-suleimanpoor-joins-uniqode', 'We are proud to announce that the skilled developer Awat Suleimanpoor joins uniQode. Awat, who joins us from Cygate, will do his first assignment at H&M. Big welcome to uniQode Awat!', '2016-03-04', '2016-03-04')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (88, 'A NEW STAR TO UNIQODE, WELCOME GUSTAV LINDERUP', 'a-new-star-to-uniqode-welcome-gustav-linderup', 'Highly recommended Gustav Linderup joins uniQode. It is with proudness we announce that Gustav Linderup has chosen uniQode as next step in his career. Gustav joins us from Nexus where he was responsible for development and maintaining neXus digital security services. With Gustav onboard uniQode continues to grow within project management and security. Gustav will do his first assignment at Tele2 as Project Manager. Big welcome Gustav!', '2016-03-16', '2016-03-16')

INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified)
VALUES (93, 'SENIOR .NET CONSULTANT ANDREAS HALL JOINS UNIQODE!', 'senior-net-consultant-andreas-hall-joins-uniqode', 'It is with pride and happines we welcome Andreas Hall to uniQode! With Andreas onboard uniQode gets even stronger within Episerver and .Net as this is Andreas experts areas. Andreas begins his journey with uniQode at Svenska Kraftnät. Big big welcome to uniQode Andreas!', '2016-04-12', '2016-04-12')
