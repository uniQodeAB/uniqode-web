...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 11)
BEGIN
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 13)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 15)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 24)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 28)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 31)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 36)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 39)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 42)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 48)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 51)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 85)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 88)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 93)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
...
IF NOT EXISTS (SELECT Id FROM [primary].[NewsArticles] WHERE Id = 96)
BEGIN
	INSERT INTO [primary].[NewsArticles](Id, Title, SearchableTitle, Body, Created, Modified, Category)
